...
const saveSecondNumber = (num) => {
  console.log('saveSecondNumber num:', num)
  secondNum = parseInt(num)
  console.log('saveSecondNumber secondNum:', secondNum)// "parseInt" is a built in function in JS that converts a string/word into a number
}
...
const multiply = (numA, numB) => {
  ...
  console.log(product)
  return product// Open up the inspector tool in Chrome and select the Console tab to see what this functions is "logging out" to the console.
}
...
// This function change the "operation" variable to be equal to the "id" of the button we choose on the web page.
